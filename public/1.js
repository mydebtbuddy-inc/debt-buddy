...
exports.default = {
  ...
  validations: {
    form: {
      ...
      interest: {
        rate: { required: _validators.required },
        fixed: { required: _validators.required }
      },
      lender: {
        name: { required: _validators.required },
        account: { required: _validators.required },
        phone: { required: _validators.required },
        address1: { required: _validators.required },
        city: { required: _validators.required },
        state: { required: _validators.required },
        zip: { required: _validators.required }
      }
    }
  },
  data: function data() {
  ...
  methods: {
    addDebt: function addDebt(event) {
      ...
      this.$store.dispatch('addDebt', form).then(function (response) {
    ...
    setValidationMessages: function setValidationMessages(tabName) {
      var _this2 = this;
      ...
      sectionFields.forEach(function (field) {
        ...
        Object.keys(sectionField.$params).some(function (param) {
          if (!sectionField[param]) {
            switch (param) {
              case 'required':
                _this2.formValidation[tabName].messages[field] = 'Field required';
                return true;
              case 'minLength':
                _this2.formValidation[tabName].messages[field] = 'Field must contain at least ' + _this2.$v.form[tabName][field].$params.minLength.min + ' characters';
                return true;
              case 'maxLength':
                _this2.formValidation[tabName].messages[field] = 'Field must contain fewer than ' + _this2.$v.form[tabName][field].$params.maxLength.max + ' characters';
                return true;
            }
          }
        });
    ...
    formattedPaymentPeriod: function formattedPaymentPeriod() {
...
exports.default = {
  ...
  computed: {
    ...
    filteredDebts: function filteredDebts() {
      var _this = this;

      return this.$store.getters.debts.filter(function (debt) {
        if (_this.filters.type.includes("All")) {
          return true;
        }

        return _this.filters.type.includes(debt.type);
      }).filter(function (typeFilteredDebt) {
        return typeFilteredDebt.name.toLowerCase().includes(_this.filters.name.toLowerCase());
      });
    }
  },
  methods: {
    percentCompleted: function percentCompleted(debt) {
    ...
    setFilterDebtType: function setFilterDebtType(type) {
      ...
      Object.keys(this.filters.types).forEach(function (debtTypeFilter) {
        if (type.includes(debtTypeFilter)) {
          _this2.filters.types[debtTypeFilter].selected = true;
          _this2.filters.type = debtTypeFilter;
        } else {
          _this2.filters.types[debtTypeFilter].selected = false;
        }
      });
    },
    ...
    formatInterest: function formatInterest(rate) {
      return (parseFloat(rate, 2) * 100).toFixed(2) + '%';
    },
    formatBillDay: function formatBillDay(payPeriod) {
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-b8141394\",\"scoped\":true,\"hasInlineConfig\":true}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./resources/assets/src/components/Debts.vue":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "\nul.nav-sorter[data-v-b8141394] {\n  overflow-x: scroll;\n  overflow-y: hidden;\n  white-space: nowrap;\n}\n.nav-sorter li[data-v-b8141394] {\n  display: inline-block;\n}\n.custom-checkbox.custom-control-inline[data-v-b8141394] {\n  margin: 0px;\n}\n.selected[data-v-b8141394] {\n  color: #4E5155 !important;\n  font-weight: 700 !important\n}\n", ""]);
                        ...
                        [
                          _c(
                            "b-form-group",
                            {
                              ...
                              attrs: {
                                label: "Debt Name",
                                feedback: _vm.formValidation.debt.messages.name
                              }
                            },
                            [
                              _c("b-input", {
                                attrs: {
                                  ...
                                  state:
                                    ...
                                    _vm.$v.form.debt.name.$invalid
                                      ? "invalid"
                                      : "null"
                                },
                                model: {
                                  value: _vm.form.debt.name,
                                  callback: function($$v) {
                                    _vm.$set(
                                      _vm.form.debt,
                                      "name",
                          ...
                          _c(
                            "b-form-group",
                            {
                              ...
                              attrs: {
                                label: "Account Type",
                                feedback: _vm.formValidation.debt.messages.type,
                                state:
                                  _vm.formValidation.debt.enabled &&
                                  _vm.$v.form.debt.type.$invalid
                                    ? "invalid"
                                    : "null"
                              }
                            },
                          ...
                          _c(
                            "b-form-group",
                            {
                              ...
                              attrs: {
                                ...
                                feedback:
                                  _vm.formValidation.debt.messages.minPayment,
                                state:
                                  _vm.formValidation.debt.enabled &&
                                  _vm.$v.form.debt.minPayment.$invalid
                                    ? "invalid"
                                    : "null"
                              }
                            },
                              ...
                              _c(
                                ...
                                [
                                  _c("b-form-input", {
                                    ...
                                    model: {
                                      value: _vm.form.debt.minPayment,
                                      callback: function($$v) {
                                        _vm.$set(
                                          _vm.form.debt,
                                          "minPayment",
                                      ...
                                      expression: "form.debt.minPayment"
                                    }
                                  })
                                ],
                                1
                          ...
                          _c(
                            "b-form-group",
                            {
                              ...
                              attrs: {
                                label: "Start Date",
                                feedback:
                                  _vm.formValidation.debt.messages.startDate,
                                state:
                                  _vm.formValidation.debt.enabled &&
                                  _vm.$v.form.debt.startDate.$invalid
                                    ? "invalid"
                                    : "null"
                              }
                            },
                            [
                              _c("datepicker", {
                                ...
                                model: {
                                  ...
                                  expression: "form.debt.startDate"
                                }
                              })
                            ],
                            1
                          ...
                          _c(
                            "b-form-group",
                            {
                              ...
                              attrs: {
                                label: "Day To Bill",
                                feedback:
                                  _vm.formValidation.debt.messages.dayToBill,
                                state:
                                  _vm.formValidation.debt.enabled &&
                                  _vm.$v.form.debt.dayToBill.$invalid
                                    ? "invalid"
                                    : "null"
                              }
                            },
                            [
                              _c("multiselect", {
                                ...
                                attrs: {
                                  label: "display",
                                  "track-by": "value",
                                  options: _vm.multiselect.daysOfMonth,
                                  searchable: false,
                                  "show-labels": false
                                },
                                model: {
                                  value: _vm.form.debt.dayToBill,
                                  callback: function($$v) {
                                    _vm.$set(
                                      _vm.form.debt,
                                      "dayToBill",
                                  ...
                                  expression: "form.debt.dayToBill"
                                }
                              })
                            ],
                            1
                          ...
                          _c(
                            "b-form-group",
                            {
                              ...
                              attrs: {
                                label: "Interest Rate",
                                state:
                                  _vm.formValidation.interest.enabled &&
                                  _vm.$v.form.interest.rate.$invalid
                                    ? "invalid"
                                    : "null"
                              }
                            },
                          ...
                          _c(
                            "b-form-group",
                            {
                              ...
                              attrs: {
                                ...
                                state:
                                  _vm.formValidation.interest.enabled &&
                                  _vm.$v.form.interest.fixed.$invalid
                                    ? "invalid"
                                    : "null"
                              }
                            },
                            [
                              _c("multiselect", {
                                ...
                                attrs: {
                                  label: "display",
                                  "track-by": "value",
                                  options: _vm.multiselect.interestTypes,
                                  searchable: false,
                                  "show-labels": false
                                },
                                model: {
                                  value: _vm.form.interest.fixed,
                                  callback: function($$v) {
                                    _vm.$set(
                                      _vm.form.interest,
                                      "fixed",
                                  ...
                                  expression: "form.interest.fixed"
                                }
                              })
                            ],
                            1
                              ...
                              _c("b-input", {
                                attrs: {
                                  ...
                                  state:
                                    ...
                                    _vm.$v.form.lender.name.$invalid
                                      ? "invalid"
                                      : "null"
                                },
                                model: {
                                  value: _vm.form.lender.name,
                                  callback: function($$v) {
                                    _vm.$set(
                                      _vm.form.lender,
                                      "name",
                            ...
                            [
                              _c("b-input", {
                                attrs: {
                                  ...
                                  state:
                                    _vm.formValidation.lender.enabled &&
                                    _vm.$v.form.lender.account.$invalid
                                      ? "invalid"
                                      : "null"
                                },
                                model: {
                                  value: _vm.form.lender.account,
                                  callback: function($$v) {
                                    _vm.$set(_vm.form.lender, "account", $$v)
                                  },
                                  expression: "form.lender.account"
                                }
                              })
                            ],
                            1
                            ...
                            [
                              _c("b-input", {
                                attrs: {
                                  ...
                                  state:
                                    _vm.formValidation.lender.enabled &&
                                    _vm.$v.form.lender.phone.$invalid
                                      ? "invalid"
                                      : "null"
                                },
                                model: {
                                  value: _vm.form.lender.phone,
                                  callback: function($$v) {
                                    _vm.$set(_vm.form.lender, "phone", $$v)
                                  },
                                  expression: "form.lender.phone"
                                }
                              })
                            ],
                            1
                            ...
                            [
                              _c("b-input", {
                                attrs: {
                                  ...
                                  state:
                                    _vm.formValidation.lender.enabled &&
                                    _vm.$v.form.lender.address1.$invalid
                                      ? "invalid"
                                      : "null"
                                },
                                model: {
                                  value: _vm.form.lender.address1,
                                  callback: function($$v) {
                                    _vm.$set(_vm.form.lender, "address1", $$v)
                                  },
                                  expression: "form.lender.address1"
                                }
                              })
                            ],
                            1
                            ...
                            [
                              _c("b-input", {
                                ...
                                model: {
                                  ...
                                  callback: function($$v) {
                                    _vm.$set(_vm.form.lender, "address2", $$v)
                                  },
                                  expression: "form.lender.address2"
                                }
                              })
                            ],
                            1
                            ...
                            [
                              _c("b-input", {
                                attrs: {
                                  ...
                                  state:
                                    _vm.formValidation.lender.enabled &&
                                    _vm.$v.form.lender.zip.$invalid
                                      ? "invalid"
                                      : "null"
                                },
                                model: {
                                  value: _vm.form.lender.zip,
                                  callback: function($$v) {
                                    _vm.$set(_vm.form.lender, "zip", $$v)
                                  },
                                  expression: "form.lender.zip"
                                }
                              })
                            ],
                            1
                            ...
                            [
                              _c("b-input", {
                                attrs: {
                                  ...
                                  state:
                                    _vm.formValidation.lender.enabled &&
                                    _vm.$v.form.lender.city.$invalid
                                      ? "invalid"
                                      : "null"
                                },
                                model: {
                                  value: _vm.form.lender.city,
                                  callback: function($$v) {
                                    _vm.$set(_vm.form.lender, "city", $$v)
                                  },
                                  expression: "form.lender.city"
                                }
                              })
                            ],
                            1
                          ...
                          _c(
                            "b-form-group",
                            {
                              ...
                              attrs: {
                                ...
                                state:
                                  _vm.formValidation.lender.enabled &&
                                  _vm.$v.form.lender.state.$invalid
                                    ? "invalid"
                                    : "null"
                              }
                            },
                            [
                              _c("multiselect", {
                                ...
                                attrs: {
                                  label: "display",
                                  "track-by": "value",
                                  options: _vm.multiselect.states,
                                  searchable: false,
                                  "show-labels": false
                                },
                                model: {
                                  value: _vm.form.lender.state,
                                  callback: function($$v) {
                                    _vm.$set(
                                      _vm.form.lender,
                                      "state",
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-b8141394\",\"hasScoped\":true,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/assets/src/components/Debts.vue":
/***/ (function(module, exports, __webpack_require__) {
    ...
    [
      ...
      _c(
        ...
        [
          _c(
            "div",
            { staticClass: "col-12 col-md px-0 pb-2" },
            [
              _c("h2", [_vm._v("Debt Dashboard")]),
              _vm._v(" "),
              _c(
                "b-btn",
                {
              ...
              _c(
                "b-btn",
                {
                  ...
                  on: {
                    click: function($event) {
                      _vm.$router.push({ path: "/payment-plan" })
                    }
                  }
                },
                [_vm._v("View Debt Repayment Plan")]
              )
            ],
            1
          ),
          ...
          _c(
            "div",
            { staticClass: "col-12 col-md-3 px-0 pb-2" },
            [
              _c("b-input", {
      ...
      _c(
        ...
        {
          staticClass:
            "nav-sorter nav bg-lighter container-p-x py-1 container-m--x mb-4"
        },
        _vm._l(_vm.filters.types, function(debtTypeFilter, type) {
          return _c("li", { key: type, staticClass: "nav-item" }, [
            _c(
              "a",
              {
                staticClass: "nav-link pl-0",
                class: {
                  selected: debtTypeFilter.selected,
                  "text-muted": !debtTypeFilter.selected
                },
                attrs: { href: "javascript:void(0)" },
                on: {
                  click: function($event) {
                    _vm.setFilterDebtType(type)
                  }
                }
              },
              [_vm._v("\n          " + _vm._s(type) + "\n        ")]
        ...
        ? _c(
            ...
            [
              _c(
                ...
                [_vm._v("Click Here To Add A Debt")]
              )
            ],
            1
          )
      ...
      _c(
        "div",
        { staticClass: "row" },
        _vm._l(_vm.filteredDebts, function(debt) {
          return _c(
            "div",
              ...
              _c(
                ...
                [
                  ...
                  _c("b-progress", {
                    ...
                    attrs: { value: _vm.percentCompleted(debt), height: "3px" }
                  }),
                  _vm._v(" "),
                  _vm.paymentPlan
                    ? _c("div", { staticClass: "card-body small pt-2 pb-0" }, [
                        _c("strong", [
                          _vm._v(_vm._s(_vm.percentCompleted(debt)) + "%")
                        ]),
                        _vm._v(" completed\n        ")
                      ])
                    : _vm._e(),
                    ...
                    _c("div", { staticClass: "row" }, [
                      _c("div", { staticClass: "col" }, [
                        _c("div", { staticClass: "text-muted small" }, [
                          _vm._v("Start Balance")
                        ]),
                        _vm._v(" "),
                        _c("div", { staticClass: "font-weight-bold" }, [
                          _vm._v(_vm._s(_vm.formatMoney(debt.initial_balance)))
                        ])
                      ]),
                      _vm._v(" "),
                      _c("div", { staticClass: "col" }, [
                        ...
                        _c("div", { staticClass: "font-weight-bold" }, [
                          _vm._v(
                            _vm._s(
                              _vm.formatInterest(debt.interest_rates[0].rate)
                            )
                          )
                        ])
                      ]),
...
/***/ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-b8141394\",\"scoped\":true,\"hasInlineConfig\":true}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./resources/assets/src/components/Debts.vue":
/***/ (function(module, exports, __webpack_require__) {

// style-loader: Adds some css to the DOM by adding a <style> tag

// load the styles
var content = __webpack_require__("./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-b8141394\",\"scoped\":true,\"hasInlineConfig\":true}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./resources/assets/src/components/Debts.vue");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("./node_modules/vue-style-loader/lib/addStylesClient.js")("5d508f0f", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-b8141394\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Debts.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-b8141394\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Debts.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
function injectStyle (ssrContext) {
  if (disposed) return
  __webpack_require__("./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-b8141394\",\"scoped\":true,\"hasInlineConfig\":true}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./resources/assets/src/components/Debts.vue")
}
var normalizeComponent = __webpack_require__("./node_modules/vue-loader/lib/component-normalizer.js")
/* script */
var __vue_script__ = __webpack_require__("./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\",[\"transform-runtime\",{\"polyfill\":false,\"helpers\":false}]]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/assets/src/components/Debts.vue")
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-b8141394\",\"hasScoped\":true,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/assets/src/components/Debts.vue")
/* template functional */
var __vue_template_functional__ = false
/* styles */
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-b8141394"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
